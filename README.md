# <span style="color:orange">Pro</span><span style="color:lightblue">Desk<span>

Projeto de API - **5º Semestre (2026)** da Fatec São José dos Campos -
**Bug Busters**

O objetivo deste projeto é desenvolver uma plataforma mobile de Help Desk para serviços de TI, permitindo o registro, acompanhamento e gerenciamento de chamados técnicos. A aplicação busca centralizar as solicitações de suporte, facilitando a comunicação entre usuários e equipe de TI e proporcionando maior organização, agilidade e controle no atendimento de demandas tecnológicas.
...
| -------- | ---------------------------------------------- | --------------- | ------------ | ---------------------------------------------------------------------- |
| Pro4tech | 5º ADS (Análise e Desenvolvimento de Sistemas) | Ronaldo Emerick | Gerson Penha | <rafael.monteiro@pro4tech.com.br> <br> <larissa.souza@pro4tech.com.br> |

## Índice

- [<span style="color:orange">Pro</span><span style="color:lightblue">Desk<span>](#Prodesk)
  - [Índice](#índice)
...
|  Team Member  | Renan Tomasi   |           [![GitHub Badge](https://img.shields.io/badge/GitHub-111217?style=flat-square&logo=github&logoColor=white)](https://github.com/renan21-tg) |                                                    [![Linkedin Badge](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/renan-tomasi/)                                                    |
...
![Bug Busters](docs/img/bug-busters-logo-black.jpg)
